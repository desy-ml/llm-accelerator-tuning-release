...
from src.environments import dl
...
def optimize(
    ...
    """
    Optimise beam in ARES DL using a reinforcement learning agent.
    """
    config = load_config(f"../models/dl/ppo/{model_name}/config")

    # Load the model
    model = PPO.load(f"../models/dl/ppo/{model_name}/model")
